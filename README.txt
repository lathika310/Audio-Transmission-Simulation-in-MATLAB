...
Running the script performs the mathematical simulations and plays the recovered audio transmission.
You may read more in the Lab4_Report.pdf file.

You may also need to install MATLAB plugins to run the script, 
and a version of MATLAB newer than R2023a.

-Lathika Sooriyapperuma
